// Encore platform copy shown in every workspace's guest app. Organizer-specific
...
export const PLATFORM_FAQ = [
  ...
  ['Can I cancel?', 'Contact the organizer using the details on this page. Cancellations and refunds follow the organizer’s terms.'],
];

export const PLATFORM_TERMS = `These terms apply when you use the Encore guest app to reserve tickets or order food and drinks from an organizer.

Your account
You sign in with your mobile number and a one-time code sent by SMS. Keep your phone and codes private. You are responsible for reservations and orders made from your account.
...
Acceptable use
Do not misuse the service, attempt to access other people's tickets or orders, or place orders you do not intend to pay for.

Changes
These terms may be updated. Continuing to use the app after an update means you accept the updated terms.`;

export const PLATFORM_PRIVACY = `What we collect
Your name and mobile number when you create an account; the reservations, orders and tips you place; and the notifications we send you.

How it is used
To sign you in, to fulfil your tickets and orders, to let organizer staff find your reservation and take payment, and to send you updates about your reservations and orders by SMS and in the app.

Who can see it
The organizer you reserve with can see your name, mobile number and the reservations and orders you place with them. Other organizers cannot.

Sign-in codes
Codes are stored only as a secure hash and expire after 5 minutes.

Your choices
You can change your name in Account. To ask for your data or account to be removed, contact the organizer's support details in Help.`;
